...
public class ChooseOneTableTech extends AbstractGameAction {
    private boolean retrieveCard = false;

    public ChooseOneTableTech() {
    ...
    public void update() {
        if (this.duration == Settings.ACTION_DUR_FAST) {
            AbstractDungeon.cardRewardScreen.customCombatOpen((ArrayList<AbstractCard>) DemoMod.getRandomTableCard(3), CardRewardScreen.TEXT[1], false);
            this.tickDuration();
        } else {
