...
public class BlueMarkPower extends AbstractPower {
    public static final String POWER_ID = DemoMod.makeID("BlueMarkPower");
    private static final PowerStrings powerStrings;
    public static final String NAME;
    public static final String[] DESCRIPTIONS;

    public BlueMarkPower(AbstractMonster owner) {
        this.ID = POWER_ID;
        this.owner = owner;
        this.name = NAME;
        this.type = PowerType.DEBUFF;
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(DemoMod.getResourcePath("powers/BlueMark84.png")), 0, 0, 84, 84);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage(DemoMod.getResourcePath("powers/BlueMark32.png")), 0, 0, 32, 32);
        this.updateDescription();
    }

    @Override
    public void onApplyPower(AbstractPower power, AbstractCreature target, AbstractCreature source) {
        if (power.ID.equals(DemoMod.makeID("RedMarkPower")) && target == owner) {
            ...
            AbstractDungeon.actionManager.addToBottom(new RemoveSpecificPowerAction(owner, source, DemoMod.makeID("RedMarkPower")));
        }
    }
