        ...
        public static SpireReturn Prefix(TopPanel topPanel, SpriteBatch sb) {
            ...
            try {
                ...
                if (AbstractDungeon.player instanceof HuntressCharacter) {
                    sb.draw(CurseValuePatch.curseIcon, Settings.WIDTH * 0.6F, ICON_Y, ICON_W, ICON_W);
                    FontHelper.renderFontLeftTopAligned(sb, FontHelper.topPanelInfoFont, String.format("%.1f", HuntressCharacter.curse), Settings.WIDTH * 0.6F + 48.0F, INFO_TEXT_Y, Color.PURPLE);
                }
